      ...
      <div className="navbar-start w-auto lg:w-1/2">
        <div className="lg:hidden dropdown" ref={burgerMenuRef}>
          ...
          <div className="flex relative w-12 h-10">
            <Image alt="logo" className="cursor-pointer" fill src="/ninippl3.png" />
          </div>
          <div className="flex flex-col">
            <span className="font-bold leading-tight"> Viaprize</span>
            <span className="text-xs"> Public Goods Funding</span>
          </div>

        <ul className="hidden lg:flex lg:flex-nowrap menu menu-horizontal px-3 gap-3">{navLinks}</ul>
      </div>
